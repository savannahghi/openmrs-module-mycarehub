...
public class HealthDiaryServiceImplTest {
	...
	@Mock
	private HealthDiaryDao fakeHealthDiaryDao;
	
	@InjectMocks
	private HealthDiaryServiceImpl healthDiaryImpl;
	...
	public void testGetPagedHealthDiaries() {
		...
		when(fakeHealthDiaryDao.getPagedHealthDiaries(searchString, pageNumber, pageSize)).thenReturn(pagedHealthDiaries);
		
		List<HealthDiary> fetchedHealthDiaries = healthDiaryImpl.getPagedHealthDiaries(searchString, pageNumber, pageSize);
