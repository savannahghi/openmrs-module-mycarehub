...
public class MyCareHubUtilTest {
  ...
  public void setup() {
    ...
    when(administrationService.getGlobalProperty(GP_MYCAREHUB_API_URL, EMPTY))
    ...
    try {
      ...
      if (response != null) {
        ...
        when(administrationService.getGlobalProperty(GP_MYCAREHUB_API_TOKEN, EMPTY))
        ...
        when(administrationService.getGlobalProperty(GP_MYCAREHUB_API_TOKEN_EXPIRY_TIME, EMPTY))
            .thenReturn(dateTimeFormat.format(dt));
      }
  ...
  public void fetchPatientAppointmentsRequests_shouldCreateCorrectSyncTimeSetting() {
    ...
    verify(myCareHubSettingsService, times(1))
        .createMyCareHubSetting(PATIENT_APPOINTMENTS_REQUESTS_GET, newSyncTime);
  }
  ...
  public void getPatientRedFlagRequests_shouldCreateCorrectSyncTimeSetting() {
    ...
    verify(myCareHubSettingsService, times(1))
        .createMyCareHubSetting(PATIENT_RED_FLAGS_REQUESTS_GET, newSyncTime);
  }
  ...
  public void getPatientHealthDiaries_shouldCreateCorrectSyncTimeSetting() {
    ...
    verify(myCareHubSettingsService, times(1))
        .createMyCareHubSetting(PATIENT_HEALTH_DIARY_GET, newSyncTime);
  }
  ...
  private PatientRegistration createDummyPatientRegistration() {
    ...
    nextOfKin.addProperty(
        NEXT_OF_KIN_CONTACTS_KEY, "07" + String.format("%08d", random.nextInt(99999999)));
  ...
  public void uploadPatientAppointments_shouldCreateCorrectSyncTimeSetting() {
    ...
    verify(myCareHubSettingsService, times(1))
        .createMyCareHubSetting(PATIENT_APPOINTMENTS_REQUESTS_POST, newSyncDate);
  }
  ...
  public void postPatientRedFlags_shouldCreateCorrectSyncTimeSetting() {
    ...
    verify(myCareHubSettingsService, times(1))
        .createMyCareHubSetting(PATIENT_RED_FLAGS_REQUESTS_POST, newSyncDate);
  }
  ...
  public void uploadPatientMedicalRecords_shouldCreateCorrectSyncTimeSetting() {
    ...
    vitalSigns.add(
        new MyCareHubVitalSign(
            ...
            myCareHubDateTimeFormatter.format(new Date()),
            "39.1"));
    vitalSigns.add(
        new MyCareHubVitalSign(
            WEIGHT_CONCEPT_KEY,
    ...
    vitalSigns.add(
        new MyCareHubVitalSign(
            PULSE_CONCEPT_KEY,
            String.valueOf(PULSE),
            myCareHubDateTimeFormatter.format(new Date()),
            "80"));
    vitalSigns.add(
        new MyCareHubVitalSign(
            CD4_CONCEPT_KEY,
            String.valueOf(CD4_COUNT),
            myCareHubDateTimeFormatter.format(new Date()),
            "500"));
    vitalSigns.add(
        new MyCareHubVitalSign(
            VIRAL_LOAD_CONCEPT_KEY,
            String.valueOf(VIRAL_LOAD),
            myCareHubDateTimeFormatter.format(new Date()),
            "1000"));
    vitalSigns.add(
        new MyCareHubVitalSign(
            RESPIRATORY_RATE_CONCEPT_KEY,
            String.valueOf(RESPIRATORY_RATE),
            myCareHubDateTimeFormatter.format(new Date()),
            "26"));
    ...
    vitalSigns.add(
        new MyCareHubVitalSign(
            ...
            String.valueOf(APPOINTMENT_DATE_CONCEPT_ID),
            myCareHubDateTimeFormatter.format(new Date()),
