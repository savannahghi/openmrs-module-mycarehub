...
public interface RestApiService {
  ...
  Call<ResponseBody> uploadPatientRegistrations(
      @Header("Authorization") String authorization, @Body PatientRegistrationRequest request);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @GET("kenya-emr/patients")
  Call<NewClientsIdentifiersResponse> getNewClientsIdentifiers(
      @Header("Authorization") String authorization, @Body NewClientsIdentifiersRequest request);
  ...
  Call<ResponseBody> uploadPatientAppointments(
      @Header("Authorization") String authorization, @Body JsonObject request);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @POST("kenya-emr/appointment-service-request")
  Call<ResponseBody> uploadPatientAppointmentRequests(
      @Header("Authorization") String authorization, @Body JsonObject request);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @GET
  Call<ResponseBody> fetchPatientAppointmentRequests(
      @Header("Authorization") String authorization, @Url String url);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @POST("kenya-emr/service_request")
  Call<ResponseBody> postPatientRedFlags(
      @Header("Authorization") String authorization, @Body JsonObject request);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @GET
  Call<ResponseBody> fetchPatientRedFlags(
      @Header("Authorization") String authorization, @Url String url);

  @POST("kenya-emr/observations")
  Call<MedicalRecordResponse> uploadMedicalRecords(
      @Header("Authorization") String authorization, @Body MedicalRecordsRequest request);

  @Headers({"Accept: application/json", "Content-Type: application/json"})
  @GET
  Call<ResponseBody> fetchPatientHealthDiaries(
      @Header("Authorization") String authorization, @Url String url);
}
